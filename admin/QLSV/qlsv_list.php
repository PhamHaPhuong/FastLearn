...
<body>
    <div class="tren">
<span>    <i class="fa fa-bookmark" aria-hidden="true"></i><a href="../home.php">Trang chủ</a> </span> <i class="fa fa-chevron-right" aria-hidden="true"></i> <span>Quản lý sinh viên</span>
    </div>
    <h1 style="text-align: center;">Danh sách sinh viên</h1>
    <div style="margin:3%; border: 2px solid black">
       <div>
        <button class="btthem">
    <a style="color: white;" href="qlsv_add.php"><i style="font-size: 20px;" class="fa fa-location-arrow" aria-hidden="true"></i> Thêm sinh viên</a> <br /> <br />
    </button>
       </div> 
        ...
        <?php foreach ($sv as $item) { ?>
            <tr>
                ...
                <td>
                    <form method="post" action="qlsv_del.php">
                        <span>
                            <i style=" color: #C7CB07; font-size: 22px;" class="fa fa-pencil-square" aria-hidden="true"></i>
                        <input class="sua" onclick="window.location = 
                        'qlsv_edit.php?maSinhVien=<?php echo $item['maSinhVien']; ?>'" type="button" value="Sửa" />
                        </span>
                        
                        <input type="hidden" name="maSinhVien" value="<?php echo $item['maSinhVien']; ?>" />
                        <span>
